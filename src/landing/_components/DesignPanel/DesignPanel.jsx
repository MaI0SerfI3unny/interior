...
export const DesignPanel = () => {
    ...
    return(
        <div className={style.designPanel}>
            <SlideOnScroll 
                direction="right" 
                className={style.designPanelContainer}>
                    ...
                    <div className={style.designPanelContainerList}>
                        <div className={style.designPanelContainerListView}>
                            ...
                            <div className={style.designPanelContainerListInfo}>
                                <p className={style.designPanelContainerListInfoTitle}>{t(`design_panel.${current.name}`)}</p>
                                <p className={style.designPanelContainerListInfoDesc}>{t(`design_panel.${current.desc}`)}</p>
                            </div>
                        </div>
                                ...
                                <div className={style.designPanelContainerListControlList}>
                                    {design_list.map(({name},key) =>  
                                        <div 
                                            ...
                                            className={`${style.designPanelContainerListControlListItem} ${currentDesign === key && style.active}`}>{t(`design_panel.${name}`)}</div>)}
                                </div>
                                <Link to="/signin" className={style.designPanelContainerListControlButton}>{t('cta.btnName')}</Link>
                            </div>
                        </div>
                    </div>
                </SlideOnScroll>
